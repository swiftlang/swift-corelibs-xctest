...
// CHECK: test.swift:51: error: FailureMessagesTestCase.testAssert : XCTAssertTrue failed - message
...
// CHECK: test.swift:58: error: FailureMessagesTestCase.testAssertEqualValues : XCTAssertEqual failed: \("1"\) is not equal to \("2"\) - message
...
// CHECK: test.swift:65: error: FailureMessagesTestCase.testAssertEqualOptionals : XCTAssertEqual failed: \("Optional\(1\)"\) is not equal to \("Optional\(2\)"\) - message
...
// CHECK: test.swift:72: error: FailureMessagesTestCase.testAssertEqualArraySlices : XCTAssertEqual failed: \("\[1\]"\) is not equal to \("\[2\]"\) - message
...
// CHECK: test.swift:79: error: FailureMessagesTestCase.testAssertEqualContiguousArrays : XCTAssertEqual failed: \("\[1\]"\) is not equal to \("\[2\]"\) - message
...
// CHECK: test.swift:86: error: FailureMessagesTestCase.testAssertEqualArrays : XCTAssertEqual failed: \("\[1\]"\) is not equal to \("\[2\]"\) - message
...
// CHECK: test.swift:93: error: FailureMessagesTestCase.testAssertEqualDictionaries : XCTAssertEqual failed: \("\[1: 2\]"\) is not equal to \("\[3: 4\]"\) - message
...
// CHECK: test.swift:100: error: FailureMessagesTestCase.testAssertEqualWithAccuracy : XCTAssertEqualWithAccuracy failed: \("1\.0"\) is not equal to \("2\.0"\) \+/- \("0\.1"\) - message
...
// CHECK: test.swift:107: error: FailureMessagesTestCase.testAssertFalse : XCTAssertFalse failed - message
...
// CHECK: test.swift:114: error: FailureMessagesTestCase.testAssertGreaterThan : XCTAssertGreaterThan failed: \("0"\) is not greater than \("0"\) - message
...
// CHECK: test.swift:121: error: FailureMessagesTestCase.testAssertGreaterThanOrEqual : XCTAssertGreaterThanOrEqual failed: \("-1"\) is less than \("0"\) - message
...
// CHECK: test.swift:128: error: FailureMessagesTestCase.testAssertLessThan : XCTAssertLessThan failed: \("0"\) is not less than \("0"\) - message
...
// CHECK: test.swift:135: error: FailureMessagesTestCase.testAssertLessThanOrEqual : XCTAssertLessThanOrEqual failed: \("1"\) is greater than \("0"\) - message
...
// CHECK: test.swift:142: error: FailureMessagesTestCase.testAssertNil : XCTAssertNil failed: "helloworld" - message
...
// CHECK: test.swift:149: error: FailureMessagesTestCase.testAssertNotEqualValues : XCTAssertNotEqual failed: \("1"\) is equal to \("1"\) - message
...
// CHECK: test.swift:156: error: FailureMessagesTestCase.testAssertNotEqualOptionals : XCTAssertNotEqual failed: \("Optional\(1\)"\) is equal to \("Optional\(1\)"\) - message
...
// CHECK: test.swift:163: error: FailureMessagesTestCase.testAssertNotEqualArraySlices : XCTAssertNotEqual failed: \("\[1\]"\) is equal to \("\[1\]"\) - message
...
// CHECK: test.swift:170: error: FailureMessagesTestCase.testAssertNotEqualContiguousArrays : XCTAssertNotEqual failed: \("\[1\]"\) is equal to \("\[1\]"\) - message
...
// CHECK: test.swift:177: error: FailureMessagesTestCase.testAssertNotEqualArrays : XCTAssertNotEqual failed: \("\[1\]"\) is equal to \("\[1\]"\) - message
...
// CHECK: test.swift:184: error: FailureMessagesTestCase.testAssertNotEqualDictionaries : XCTAssertNotEqual failed: \("\[1: 1\]"\) is equal to \("\[1: 1\]"\) - message
...
// CHECK: test.swift:191: error: FailureMessagesTestCase.testAssertNotEqualWithAccuracy : XCTAssertNotEqualWithAccuracy failed: \("1\.0"\) is equal to \("1\.0"\) \+/- \("0\.1"\) - message
...
// CHECK: test.swift:198: error: FailureMessagesTestCase.testAssertNotNil : XCTAssertNotNil failed - message
...
// CHECK: test.swift:205: error: FailureMessagesTestCase.testAssertTrue : XCTAssertTrue failed - message
...
// CHECK: test.swift:212: error: FailureMessagesTestCase.testFail : failed - message
